...
def get_square_mask(data_shape, square_size, n_squares, noise_val=(0, 0), channel_wise_n_val=False, data=None):
    ...
    def mask_random_square(img_shape, square_size, n_val, channel_wise_n_val=False, square_pos=None):
        ...
        if square_pos is None or len(square_pos) == 0:
            ...
            h_start = max(pos_wh[0] - square_size // 2, 0)
            w_start = max(pos_wh[1] - square_size // 2, 0)
